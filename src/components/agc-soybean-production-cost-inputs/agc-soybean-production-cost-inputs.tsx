...
@Component({
    tag: 'agc-soybean-production-cost-inputs'
})
export class AgcSoybeanProductionCostInputs {
    @Prop() socket: string = ""
    @State() data: any
            ...
            <section data-wizard-results ref={c => this.section = c as HTMLElement}>
                ...
                <div style={{display: this.ready ? 'block' : 'none'}}>
                    ...
                    <li>
                                ...
                                <span class="agc-results__value">${parseMoney(this.data['marketPrice']).dollars}</span>
                                <sub><strong>.{parseMoney(this.data['marketPrice']).cents}</strong></sub>
                            </li>                            
                            <li>
