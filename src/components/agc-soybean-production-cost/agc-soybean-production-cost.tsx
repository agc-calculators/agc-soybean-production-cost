...
@Component({
  tag: "agc-soybean-production-cost"
})
export class AgcSoybeanProductionCost {
  @Prop() socket: string = "";
  @Prop() tract: string = "";
  @Prop() mode: "full" | "step" = "step";
  @Prop() units: any = { land: "acre", yield: "bu/acre", soybeans: "bu" };
  @State() currentStep = 0;
  @State() cache = {};
    ...
    return (
      <div>
        <form
          ...
          data-wizard="agc-soybean-production-cost"
        ...
        >
          ...
          <section data-wizard-section="0">
            <div class="agc-wizard__field">
              ...
              <p data-i18n={`hints.market-price.${this.units["soybeans"]}`}>
                ⮤ Enter the expected market price for soybeans per bushel.
              </p>
            </div>
  ...
  showResults() {
    let marketPrice = parseFloat((this.form.querySelector(
      '[name="marketPrice"'
