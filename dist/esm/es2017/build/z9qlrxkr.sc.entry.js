...
class AgcSoybeanProductionCostResultsPlaceholder {
    render() {
    ...
    static get is() { return "agc-soybean-production-cost-results-placeholder"; }
}

export { AgcSoybeanProductionCostResultsPlaceholder };
